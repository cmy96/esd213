...
// docker run --network="host" -i -p 8092:8080 -e DB_USERNAME=bwce -e DB_PASSWORD= -e DB_URL=jdbc:mysql://192.168.56.1:3306/bookings -e AMQP_PORT=192.168.56.1:5672 -e AMQP_USERNAME=bwce -e AMQP_PASSWORD=bwce -e HTTPHOSTNAME=localhost -e HTTPHOSTPORT=8087 my/bookings:1.0.3
?>